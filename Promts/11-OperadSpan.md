In 'CategoricalLogic/Assoc.lean':
* Fill all sorries
* Add a 'Monad' instance (as in 'Mathlib.CategoryTheory.Monad') for 'Assoc'.
* Add an instance for 'Limits.PreservesLimitsOfShape Limits.WalkingCospan' for 'Assoc'
